...
#include "HomeostaticSTDPmodule.h"
...
/*
 * There are three scenarios, in which HomeostaticSTDPmodule can be loaded by NEST:
 *
...
mynest::HomeostaticSTDPmodule HomeostaticSTDPmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::HomeostaticSTDPmodule::HomeostaticSTDPmodule()
{
#ifdef LINKED_MODULE
...
mynest::HomeostaticSTDPmodule::~HomeostaticSTDPmodule() = default;

const std::string
mynest::HomeostaticSTDPmodule::name() const
{
  return std::string( "Homeostatic STDP Module" ); // Return name of the module
}

const std::string
mynest::HomeostaticSTDPmodule::commandstring( void ) const
{
  // Instruct the interpreter to load homeostaticstdpmodule-init.sli
  return std::string( "(HomeostaticSTDPmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::HomeostaticSTDPmodule::init( SLIInterpreter* i )
{
  ...
  */
  nest::register_connection_model< STDPHomeostaticConnection >( "stdp_homeostatic_synapse" );
} // HomeostaticSTDPmodule::init()
